...
def send_confirmation_email(request, user):
    ...
    email_data = {
                "from": "PreciousHairz <noreply@precioushairz.com>",
                "to": recipient,
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            <tr>
              ...
              <img src="https://precioushairz.com/static/assets/imgs/martmes-logo-removebg-preview.png" style="border-radius: 15px;" height="100"/>
                </td>
            </tr>
            ...
            <tr>
              <td valign="top" align="center" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:10px 40px 40px 40px">
                <a href="https://precioushairz.com">precioushairz.com</a></td>
            </tr>
    ...
    email_data = {
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            ...
            <tr>
              <td valign="top" align="left" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:40px 40px 20px 40px">
              You requested a password reset on your<br> precioushairz account.</td>
            </tr>
            <tr>
              <td valign="top" align="left" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:40px 40px 20px 40px">
